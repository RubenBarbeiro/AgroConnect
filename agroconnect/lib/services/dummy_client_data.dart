...
class DummyClientData {
  ...
  void _generateDummyClients() {  // Added void return type
    ...
    client1 = ClientModel(
        ...
        updatedAt: null,
        name: 'João Silva',
        imagePath: 'assets/user-images/client1.jpg',
    ...
    client2 = ClientModel(
        ...
        updatedAt: null,
        name: 'Maria Santos',
        imagePath: 'assets/user-images/client2.jpg',
    ...
    client3 = ClientModel(
      ...
      updatedAt: null,
      name: 'João Ferreira',
      imagePath: 'assets/user-images/client3.jpg',
      email: 'joao@email.com',
      city: 'Lisboa',
      parish: 'Alvalade',
      postalCode: '1700-111',
    ...
    client4 = ClientModel(
      ...
      updatedAt: null,
      name: 'Ana Oliveira',
      imagePath: 'assets/user-images/client4.jpg',
      email: 'ana@email.com',
      city: 'Coimbra',
      parish: 'Sé Nova',
      postalCode: '3000-001',
    ...
    client5 = ClientModel(
      ...
      updatedAt: null,
      name: 'Carlos Silva',
      imagePath: 'assets/user-images/client5.jpg',
    ...
    client6 = ClientModel(
      ...
      updatedAt: null,
      name: 'Sofia Costa',
      imagePath: 'assets/user-images/client6.jpg',
    ...
    client7 = ClientModel(
      ...
      updatedAt: null,
      name: 'Ricardo Mendes',
      imagePath: 'assets/user-images/client7.jpg',
    ...
    client8 = ClientModel(
      ...
      imagePath: 'assets/user-images/client8.jpg',
    ...
    client9 = ClientModel(
      ...
      updatedAt: null,
      name: 'Tiago Rocha',
      imagePath: 'assets/user-images/client9.jpg',
    ...
    client10 = ClientModel(
      ...
      updatedAt: null,
      name: 'Helena Pinto',
      imagePath: 'assets/user-images/client10.jpg',
